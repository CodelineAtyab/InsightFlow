...
const addToWwc = (givenContent, cardId, parentElemObj) => {
  addCardInCol("div1", givenContent, cardId, parentElemObj);
};

const addToCfc = (givenContent, cardId, parentElemObj) => {
  addCardInCol("div2", givenContent, cardId, parentElemObj);
};

const addToAic = (givenContent, cardId, parentElemObj) => {
  addCardInCol("div3", givenContent, cardId, parentElemObj);
};
